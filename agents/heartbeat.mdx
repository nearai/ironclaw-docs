...
description: Proactive periodic execution every 30 minutes
---

The heartbeat system gives IronClaw agency between conversations. Every 30 minutes, it reads `HEARTBEAT.md` from the workspace and executes a checklist of proactive tasks — without you having to ask.
...
Use `memory_write` to create or update the heartbeat checklist:
...
<CardGroup cols={2}>
  <Card title="Identity Files" icon="user" href="/agents/identity-files">
    AGENTS.md, SOUL.md, USER.md — injected into every system prompt
  </Card>

  <Card title="Memory & Workspace" icon="database" href="/agents/memory">
    How the workspace filesystem and memory tools work
  </Card>

  <Card title="Routines" icon="clock" href="/agents/routines">
    Cron and reactive routines for more fine-grained scheduling
  </Card>
</CardGroup>
