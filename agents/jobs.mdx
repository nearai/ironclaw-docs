...
Four built-in tools let the agent (and you) manage jobs at runtime:
...
<CardGroup cols={2}>
  <Card title="Self-Repair" icon="wrench" href="/agents/self-repair">
    How stuck jobs are detected and recovered automatically
  </Card>

  <Card title="Agent Overview" icon="cpu" href="/agents/index">
    Agent loop, session model, and context management
  </Card>
</CardGroup>
