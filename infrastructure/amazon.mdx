...
![EC2 intance configuration](/images/infrastructure/amazon/amazon-firewall.png)
...
Now that we are inside the instance, we need to perform some initial configuration. We want to strengthen security by setting up a dedicated user and configuring firewall rules.
