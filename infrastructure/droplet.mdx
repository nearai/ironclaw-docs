...
Want to talk with your agent using a messaging app? Check out the **Channels** documentation to learn how to connect.

Need your agent to perform complex tasks that require multiple tools? Check out the **Extensions** documentation.
